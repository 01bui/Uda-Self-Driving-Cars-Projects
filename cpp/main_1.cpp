...
*/
std::cout << "evaluation " << gaussianone.evaluate(10.5) << std::endl;
std::cout << "evaluation " << gaussianone.evaluate(55.4) << std::endl;
std::cout << "evaluation " << gaussiantwo.evaluate(35.6) << std::endl;
std::cout << "evaluation " << gaussiantwo.evaluate(29.4) << std::endl;
...
std::cout << "average " << gaussianone.getMu() << std::endl;
std::cout << "variance " << gaussiantwo.getSigma2() << std::endl;
...
*/
Gaussian gaussianthree(gaussianone.mul(gaussiantwo).getMu(), gaussianone.mul(gaussiantwo).getSigma2());
std::cout << "average " << gaussianthree.getMu() << std::endl;
std::cout << "variance " << gaussianthree.getSigma2() << std::endl;

Gaussian gaussianfour(gaussianone.add(gaussiantwo).getMu(), gaussianone.add(gaussiantwo).getSigma2());
std::cout << "average " << gaussianfour.getMu() << std::endl;
std::cout << "variance " << gaussianfour.getSigma2() << std::endl;
